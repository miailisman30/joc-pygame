...
def main():
    ...
    if n_envs > 1:
        ...
        vec_env = DummyVecEnv([make_env(headless, frame_skip, args.seed, bool(args.shaping), bool(args.curriculum))])

    if bool(args.normalize):
        vec_env = VecNormalize(vec_env, training=True, norm_obs=True, norm_reward=True, clip_obs=10.0)
